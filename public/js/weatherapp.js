...
define('lib/views/weatherDetails',['require','exports','module'],function (require, exports, module) {
    ...
    render: function () {
        ...
        this.model.getCityObj(function (response) {
            ...
            template = _.template(weatherDetailsTemplate, {
                newCity: response.attributes.cityList[newCity.name]
            });

        view.$el.html(template);

        });
        /*this.model.getCityOb(function (response) {
...
define('lib/views/cityList',['require','exports','module','./weatherDetails'],function (require, exports, module) {
var CityListView,
    cityListTemplate,
...
define('lib/server',['require','exports','module'],function (require, exports, module) {
var server,
    requestURL,
    cityObj = {};
...
define('lib/models/cityData',['require','exports','module','../server'],function (require, exports, module) {
var CityData,
...
define('lib/start',['require','exports','module','./views/cityList','./views/weatherDetails','./models/cityData'],function (require, exports, module) {
